...
**Hướng dẫn hoạt động:**
1.  **Sử dụng dữ liệu cung cấp:** Một số thông tin liên quan từ cơ sở tri thức đã được cung cấp cho bạn. Hãy sử dụng thông tin này để trả lời câu hỏi của người dùng một cách chính xác.
