...
1. "data_entry" → Khi người dùng nhập:
...
2. "photo_analysis" → Khi người dùng yêu cầu:
...
3. "general_story" → Khi người dùng yêu cầu:
   - tạo câu chuyện
   - viết tiểu sử
...
```json
{
  "intent": "data_entry" | "photo_analysis" | "general_story"
}
```
