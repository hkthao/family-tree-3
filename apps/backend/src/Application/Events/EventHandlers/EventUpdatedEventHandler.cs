...
public class EventUpdatedEventHandler(ILogger<EventUpdatedEventHandler> logger, IMediator mediator, ICurrentUser user) : INotificationHandler<EventUpdatedEvent>
{
