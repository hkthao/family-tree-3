...
public class MemberUpdatedEventHandler(ILogger<MemberUpdatedEventHandler> logger, IMediator mediator, IFamilyTreeService familyTreeService, ICurrentUser _user) : INotificationHandler<MemberUpdatedEvent>
{
