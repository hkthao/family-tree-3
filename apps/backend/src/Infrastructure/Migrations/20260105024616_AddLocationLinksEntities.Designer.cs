...
namespace backend.Infrastructure.Migrations
{
    ...
    [Migration("20260105024616_AddLocationLinksEntities")]
    partial class AddLocationLinksEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Domain.Entities.LocationLink", b =>
                {
                    ...
                    b.Property<Guid>("FamilyLocationId")
                        .HasColumnType("char(36)")
                        .HasColumnName("family_location_id");
            ...
            modelBuilder.Entity("backend.Domain.Entities.LocationLink", b =>
                {
                    b.HasOne("backend.Domain.Entities.FamilyLocation", "FamilyLocation")
                        .WithMany()
                        .HasForeignKey("FamilyLocationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_location_links_family_locations_family_location_id");

                    b.Navigation("FamilyLocation");
                });
