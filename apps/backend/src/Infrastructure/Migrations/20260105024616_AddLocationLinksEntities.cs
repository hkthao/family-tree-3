...
{
    /// <inheritdoc />
    public partial class AddLocationLinksEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ref_id = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ref_type = table.Column<int>(type: "int", nullable: false),
                    description = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    family_location_id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_location_links", x => x.id);
                    table.ForeignKey(
                        name: "fk_location_links_family_locations_family_location_id",
                        column: x => x.family_location_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_location_links_family_location_id",
