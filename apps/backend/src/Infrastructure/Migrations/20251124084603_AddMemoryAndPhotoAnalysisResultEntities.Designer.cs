...
namespace backend.Infrastructure.Migrations
{
    ...
    [Migration("20251124084603_AddMemoryAndPhotoAnalysisResultEntities")]
    partial class AddMemoryAndPhotoAnalysisResultEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Domain.Entities.Memory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                    ...
                    b.Property<Guid?>("PhotoAnalysisId")
                        .HasColumnType("char(36)")
                        .HasColumnName("photo_analysis_id");

                    b.Property<Guid?>("PhotoAnalysisResultId")
                        .HasColumnType("char(36)")
                        .HasColumnName("photo_analysis_result_id");
                    ...
                    b.HasIndex("MemberId")
                        .HasDatabaseName("ix_memories_member_id");

                    b.HasIndex("PhotoAnalysisResultId")
                        .HasDatabaseName("ix_memories_photo_analysis_result_id");
            ...
            modelBuilder.Entity("backend.Domain.Entities.PhotoAnalysisResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                    ...
                    b.Property<string>("YearEstimate")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("year_estimate");

                    b.HasKey("Id")
                        .HasName("pk_photo_analysis_results");

                    b.ToTable("photo_analysis_results");
                });
            ...
            modelBuilder.Entity("backend.Domain.Entities.Memory", b =>
                {
                    b.HasOne("backend.Domain.Entities.Member", "Member")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_memories_members_member_id");

                    b.HasOne("backend.Domain.Entities.PhotoAnalysisResult", "PhotoAnalysisResult")
                        .WithMany("Memories")
                        .HasForeignKey("PhotoAnalysisResultId")
                        .HasConstraintName("fk_memories_photo_analysis_results_photo_analysis_result_id");

                    b.Navigation("Member");

                    b.Navigation("PhotoAnalysisResult");
                });
