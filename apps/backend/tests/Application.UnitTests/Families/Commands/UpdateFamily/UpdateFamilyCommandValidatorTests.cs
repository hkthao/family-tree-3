...
public class UpdateFamilyCommandValidatorTests
{
    ...
    public void ShouldNotHaveError_WhenAvatarBase64IsValid()
    {
        ...
        var command = new UpdateFamilyCommand { Id = Guid.NewGuid(), Name = "Valid Name", AvatarBase64 = validBase64, Visibility = "Public" };
        var result = _validator.TestValidate(command);
    ...
    public void ShouldNotHaveError_WhenAvatarBase64IsNull()
    {
        ...
        var command = new UpdateFamilyCommand { Id = Guid.NewGuid(), Name = "Valid Name", AvatarBase64 = null, Visibility = "Public" };
        var result = _validator.TestValidate(command);
        result.ShouldNotHaveValidationErrorFor(x => x.AvatarBase64);
    }
    ...
    public void ShouldNotHaveError_WhenAvatarBase64IsEmpty()
    {
        ...
        var command = new UpdateFamilyCommand { Id = Guid.NewGuid(), Name = "Valid Name", AvatarBase64 = string.Empty, Visibility = "Public" };
        var result = _validator.TestValidate(command);
        result.ShouldNotHaveValidationErrorFor(x => x.AvatarBase64);
    }
    ...
    public void ShouldHaveError_WhenAvatarBase64IsInvalidFormat()
    {
        ...
        var command = new UpdateFamilyCommand { Id = Guid.NewGuid(), Name = "Valid Name", AvatarBase64 = "invalid-base64-!@#", Visibility = "Public" };
        var result = _validator.TestValidate(command);
    ...
    public void ShouldHaveError_WhenAvatarBase64ExceedsSizeLimit()
    {
        ...
        var command = new UpdateFamilyCommand { Id = Guid.NewGuid(), Name = "Valid Name", AvatarBase64 = largeBase64, Visibility = "Public" };
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(x => x.AvatarBase64)
