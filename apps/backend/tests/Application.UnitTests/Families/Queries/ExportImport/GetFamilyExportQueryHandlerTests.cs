...
public class GetFamilyExportQueryHandlerTests : TestBase
{
    ...
    public async Task Handle_ShouldReturnFamilyExportDto_WhenFamilyExists()
    {
        ...
        var member1 = new Member("Doe", "John", "JOHNDOE", familyId, "Johnny", "Male", DateTime.Now.AddYears(-30), null, "Place1", null, "Occupation1", "Avatar1", "Bio1", 1);
        member1.SetId(Guid.NewGuid());
        var member2 = new Member("Doe", "Jane", "JANEDOE", familyId, "Janie", "Female", DateTime.Now.AddYears(-28), null, "Place2", null, "Occupation2", "Avatar2", "Bio2", 2);
