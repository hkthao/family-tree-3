...
onMounted(async () => {
  ...
  buildDate.value = window.runtimeConfig.VITE_APP_BUILD_DATE || 'N/A';
  environment.value = window.runtimeConfig.VITE_APP_ENVIRONMENT || 'N/A';
  apiEndpoint.value = window.runtimeConfig.VITE_API_BASE_URL || 'N/A';
  commitId.value = window.runtimeConfig.VITE_APP_COMMIT_ID || 'N/A';
