<template>
  <v-card class="mb-4">
    ...
    <v-card-text>
      <div v-if="loading" class="text-center">{{ t('dashboard.genderRatioChart.loading') }}</div>
      <div v-else-if="maleRatio === undefined || femaleRatio === undefined || (maleRatio === 0 && femaleRatio === 0)" class="text-center text-medium-emphasis">
