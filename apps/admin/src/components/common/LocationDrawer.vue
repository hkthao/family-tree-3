<template>
  <BaseCrudDrawer :class="cssClass" :model-value="props.modelValue" @update:model-value="emit('update:modelValue', $event)"
    @close="emit('update:modelValue', false)" data-testid="location-drawer">
...
interface LocationDrawerProps {
  ...
  cssClass?: string | null; // Optional FamilyId for filtering locations
}
...
const handleLocationAdded = () => {
  emit('update:modelValue', false); // Close the dialog after a new location is saved
};
