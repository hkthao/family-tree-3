...
import type { AiChatMessage, MemberDto } from '@/types'; // Import the new message type
...
export function useAiChat(familyId: string, deps: UseAiChatDeps = defaultAiChatDeps) {
  ...
  const messages = ref<AiChatMessage[]>([
    ...
    // Nếu bạn cần hướng dẫn chi tiết hơn về các tính năng hoặc cách sử dụng ứng dụng, tôi sẵn sàng hỗ trợ thêm nhé!`, intent :"RELATIONSHIP_LOOKUP_PAGE" },
  ]);
