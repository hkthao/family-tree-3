...
describe('member.store', () => {
  ...
  beforeEach(() => {
    ...
    // mockSearch.mockResolvedValue(ok(mockPaginatedMembers)); // Moved to specific tests
  });
  ...
  describe('_loadItems', () => {
    it('should load items successfully', async () => {
      mockSearch.mockResolvedValue(ok(mockPaginatedMembers));
  ...
  describe('addItem', () => {
    it('should add an item successfully', async () => {
      mockSearch.mockResolvedValue(ok(mockPaginatedMembers)); // _loadItems is called after successful add
