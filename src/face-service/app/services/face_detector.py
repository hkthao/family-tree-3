...
class DlibFaceDetector:
    ...
    def detect_faces(self, image: np.ndarray):
        ...
        try:
            ...
            detections = self.detector(gray_image, 1) # The '1' means to upsample the image 1 time
            ...
            for d in detections:
                ...
                detected_faces.append({
                    ...
                    'confidence': 0.99 # Dlib's detector doesn't provide a confidence score directly, use a high dummy value
                })
