...
public class GetSystemConfigurationQueryHandler(IApplicationDbContext context) : IRequestHandler<GetSystemConfigurationQuery, Result<SystemConfigurationDto>>
{
