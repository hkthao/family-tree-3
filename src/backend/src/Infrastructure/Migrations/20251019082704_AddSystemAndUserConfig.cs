...
{
    /// <inheritdoc />
    public partial class AddSystemAndUserConfig : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserConfigs", x => new { x.UserProfileId, x.Key });
                    table.ForeignKey(
                        name: "FK_UserConfigs_UserProfiles_UserProfileId",
