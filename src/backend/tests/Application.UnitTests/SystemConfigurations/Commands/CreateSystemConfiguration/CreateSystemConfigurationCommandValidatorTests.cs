...
public class CreateSystemConfigurationCommandValidatorTests
{
    private readonly CreateSystemConfigurationCommandValidator _validator;

    public CreateSystemConfigurationCommandValidatorTests()
    {
        _validator = new CreateSystemConfigurationCommandValidator();
    }
    ...
    public void ShouldHaveValidationError_WhenKeyExceedsMaxLength()
    {
        ...
        // 1. Arrange: Tạo một CreateSystemConfigurationCommand với Key dài hơn 200 ký tự.
    ...
    public void ShouldHaveValidationError_WhenValueIsEmpty()
    {
        ...
        // 1. Arrange: Tạo một CreateSystemConfigurationCommand với Value trống.
    ...
    public void ShouldHaveValidationError_WhenValueTypeIsEmpty()
    {
        ...
        // 1. Arrange: Tạo một CreateSystemConfigurationCommand với ValueType trống.
    ...
    public void ShouldHaveValidationError_WhenValueTypeExceedsMaxLength()
    {
        ...
        // 1. Arrange: Tạo một CreateSystemConfigurationCommand với ValueType dài hơn 50 ký tự.
    ...
    public void ShouldHaveValidationError_WhenDescriptionExceedsMaxLength()
    {
        ...
        // 1. Arrange: Tạo một CreateSystemConfigurationCommand với Description dài hơn 1000 ký tự.
