...
public class GetCurrentUserProfileQueryHandlerTests : TestBase
{
    ...
    {
        _handler = new GetCurrentUserProfileQueryHandler(_context, _mockUser.Object, _mapper);
    }
    ...
    /// <summary>
    /// Kiểm tra xem hồ sơ người dùng hiện tại có được trả về thành công.
    /// </summary>
    [Fact]
    public async Task Handle_Should_ReturnCurrentUserProfile_Successfully()
    {
        // Arrange
    ...
    /// <summary>
    /// Kiểm tra khi hồ sơ người dùng hiện tại không tồn tại.
    /// </summary>
    [Fact]
