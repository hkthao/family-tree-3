...
import { DashboardView, FamilyTreeView, AddMemberView, MembersView, TimelineView, ProfileView, UserManagementView, RoleManagementView, FamilySearchView } from '@/views';
