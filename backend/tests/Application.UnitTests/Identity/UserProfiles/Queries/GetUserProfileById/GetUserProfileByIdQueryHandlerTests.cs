...
public class GetUserProfileByIdQueryHandlerTests : TestBase
{
    ...
    {
        _handler = new GetUserProfileByIdQueryHandler(_context, _mapper);
    }
    ...
    /// <summary>
    /// Kiểm tra xem hồ sơ người dùng có được trả về thành công khi tìm thấy bằng ID.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Kiểm tra khi không tìm thấy hồ sơ người dùng bằng ID.
    /// </summary>
    [Fact]
    public async Task Handle_Should_ReturnFailure_When_NotFound()
    {
        ...
        var nonExistentUserProfileId = Guid.NewGuid();
        var query = new GetUserProfileByIdQuery { Id = nonExistentUserProfileId };
